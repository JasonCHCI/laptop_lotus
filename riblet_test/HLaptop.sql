...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2016 at 09:50 AM
...
CREATE TABLE `address` (
  ...
  `object` varchar(7) NOT NULL DEFAULT 'Address',
  ...
  `carrier_facility` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `company` varchar(255) NOT NULL,
  `phone` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `federal_tax_id` varchar(255) NOT NULL,
  `state_tax_id` varchar(255) NOT NULL,
  `verifications` varchar(255) NOT NULL
...
(0, 1, 5, 1, '2016-10-29 02:40:18'),
(0, 4, 5, 1, '2016-10-29 02:40:35');
...
CREATE TABLE `parcel` (
  `id` varchar(255) DEFAULT NULL,
  `object` varchar(6) NOT NULL DEFAULT 'Parcel',
  `mode` varchar(255) NOT NULL DEFAULT 'test',
  `length` float NOT NULL,
  `width` float NOT NULL,
  `height` float NOT NULL,
  `predefined_package` varchar(255) NOT NULL,
...
CREATE TABLE `shipment` (
  `id` varchar(255) DEFAULT NULL,
  `object` varchar(8) NOT NULL DEFAULT 'Shipment',
  `reference` varchar(255) NOT NULL,
  `mode` varchar(10) NOT NULL DEFAULT 'test',
  `to_address` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `from_address` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `return_address` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `buyer_address` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `parcel` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `customs_info` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `scan_form` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `forms` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `insurance` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `rates` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `selected_rate` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `postate_label` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `messages` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `options` varchar(255) NOT NULL DEFAULT 'link_to_what',
  `is_return` tinyint(1) NOT NULL,
  `tracking_code` varchar(255) DEFAULT NULL,
  `usps_zone` varchar(255) NOT NULL,
  `status` varchar(255) NOT NULL,
  `tracker` varchar(255) DEFAULT 'link_to_what',
  `fees` varchar(255) NOT NULL DEFAULT 'must_implement',
  `refund_status` varchar(255) NOT NULL,
  `batch_id` varchar(255) NOT NULL,
  `batch_status` varchar(255) NOT NULL,
  `batch_message` varchar(255) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(5, 'Stephen', 'Riblet', 'sriblet@vt.edu', 'sriblet', 'pass');
